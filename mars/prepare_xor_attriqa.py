...
xor_attriqa_test = pd.read_json(DATASET_PATH, lines=True)

# Named to be consistent with the mlqa code
dataset_merged = pd.DataFrame()
dataset_merged["Document_en"] = xor_attriqa_test["passage_en"]
dataset_merged["Answer_en"] = xor_attriqa_test["prediction_translated_en"]
dataset_merged["Query_en"] = xor_attriqa_test["query_translated_en"]
dataset_merged["Document_ja"] = xor_attriqa_test["passage_in_language"]
dataset_merged["Answer_ja"] = xor_attriqa_test["prediction"]
dataset_merged["Query_ja"] = xor_attriqa_test["query"]
dataset_merged["Answer_Faithfulness"] = xor_attriqa_test["ais"].apply(lambda x: 1 if x == True else 0)
...
dataset_merged.to_csv("multilingual_data/attri_qa_test.tsv", sep="\t", index=False)
...
def create_few_shot_files(few_shot):
    ...
    few_shot_files = {
        "attri_qa_test_few_shot_en_en.tsv": few_shot[["Document_en", "Answer_en", "Query_en", "Context_Relevance_Label", "Answer_Faithfulness_Label", "Answer_Relevance_Label", "Language_Consistency_Label", "Contradictory_Answer"]],
        "attri_qa_test_few_shot_ja_ja.tsv": few_shot[["Document_ja", "Answer_ja", "Query_ja", "Context_Relevance_Label", "Answer_Faithfulness_Label", "Answer_Relevance_Label", "Language_Consistency_Label", "Contradictory_Answer"]],
        "attri_qa_test_few_shot_en_ja.tsv": few_shot[["Document_en", "Answer_ja", "Query_ja", "Context_Relevance_Label", "Answer_Faithfulness_Label", "Answer_Relevance_Label", "Language_Consistency_Label", "Contradictory_Answer"]],
        "attri_qa_test_few_shot_ja_en.tsv": few_shot[["Document_ja", "Answer_en", "Query_en", "Context_Relevance_Label", "Answer_Faithfulness_Label", "Answer_Relevance_Label", "Language_Consistency_Label", "Contradictory_Answer"]],
    }

    few_shot_en_ja_wrong = few_shot_files["attri_qa_test_few_shot_en_ja.tsv"].copy()
    few_shot_ja_en_wrong = few_shot_files["attri_qa_test_few_shot_ja_en.tsv"].copy()
    ...
    few_shot_files["attri_qa_test_few_shot_en_ja.tsv"] = pd.concat([few_shot_files["attri_qa_test_few_shot_en_ja.tsv"], few_shot_en_ja_wrong], axis=0, ignore_index=True)
    few_shot_files["attri_qa_test_few_shot_ja_en.tsv"] = pd.concat([few_shot_files["attri_qa_test_few_shot_ja_en.tsv"], few_shot_ja_en_wrong], axis=0, ignore_index=True)
...
if not os.path.exists("multilingual_data/attri_qa_test_few_shot_en_en.tsv"):
...
create_dataset_file(dataset_merged, "en", "en", "multilingual_data/attri_qa_test_en_en.tsv")
create_dataset_file(dataset_merged, "ja", "ja", "multilingual_data/attri_qa_test_ja_ja.tsv")
create_dataset_file(dataset_merged, "ja", "en", "multilingual_data/attri_qa_test_ja_en.tsv")
create_dataset_file(dataset_merged, "en", "ja", "multilingual_data/attri_qa_test_en_ja.tsv")

# Combine all datasets
dataset = pd.concat([
    pd.read_csv("multilingual_data/attri_qa_test_en_en.tsv", sep="\t"),
    pd.read_csv("multilingual_data/attri_qa_test_ja_ja.tsv", sep="\t"),
    pd.read_csv("multilingual_data/attri_qa_test_ja_en.tsv", sep="\t"),
    pd.read_csv("multilingual_data/attri_qa_test_en_ja.tsv", sep="\t")
...
for ratio in positive_negative_ratios:
    negatives_to_add = int((1 - ratio) / ratio * len(dataset))
